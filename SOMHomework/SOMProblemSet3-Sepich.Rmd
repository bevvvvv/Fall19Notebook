...
The fundamental frequency in air would follow the formula used for a closed-open pipe of $f_1 = \frac{V_{air}}{4L}$. This means that the frequency is directly correlated to the speed of sound. Since $970 / 331 = 2.93$, we can divide the frequency by 2.93 to get the new fundamental. This value would be 150 / 2.93 = **51.19Hz**.
...
The fundamental frequency is **110Hz** as stated. The second harmonic would be 2 times greater or **220Hz**. The third harmonic would be 3 times greater than the fundamental, which is **330Hz**. The fourth harmonic would be 4 times greater than the first harmonic or **440Hz** (2 octaves).
...
**Sackbut**: The sackbut seems like a transition from the Trumpet to the Trombone. It has a brassy tone to it and in both videos I watched they noted the ability to play quietyly and loudly. Although brassy it has a rich tone to it that brass instruments tend to have. The video I watched of an actual song the instrument seems very majestic and exalted, which makes sense since the piece they were playing takes place in a church.

https://www.youtube.com/watch?v=jPJNJr6iBrs
https://www.youtube.com/watch?v=XO4ciBWblx0

**Erhu**: While the sackbut is a brass instrument, the erhu is a string instrument. The erhu felt very sharp and dissonant to me, which likely has to do with its eastern origins. You could see the resonator on the ehru very clearly as the string is attached to a stick body with a large bulb on the end. While the sackbut felt majestic, the ehru felt nasaly and solemn. The shrill sound of it made it feel cold compared to the warm sound of the sackbut. One thing both instruments have in common is the ability to smoothly transition between notes.

https://www.youtube.com/watch?v=YJ2O7vQfeiE

# Problem 10

On the musical grand staff below, write the name of each pitch. Then, find and circle the three adjacent notes that best represent an open-open pipe's fundamental first overtone second overtone relationship. ![](ProblemSet3Staff.png)
