...
Using the critical region approach we have $Z > Z_{\alpha} = Z_{0.05} = 1.645$. Since our test statistic $1.8 > 1.645$ we **can** reject the null hypothesis that the median is 5.900.
...
Using the critical region approach at $\alpha = 0.05$ significance level, we reject if $Z > Z_{\alpha} = Z_{0.05} = 1.645$. Given our test statistic of $5.635 > 1.645$ we **can** reject the null hypothesis $H_0$ that $m = 5.900$.
...
Given a significance level of $\alpha = 0.05$, using the t table we have the critical region $t(n-1) > t_{\alpha}(n-1) = t_{0.05}(24) = 1.711$. Since our test statistic $2.608 > 1.711$ we **can** reject the null hypothesis that $m = 5.900$
